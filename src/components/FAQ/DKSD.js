                        ...
                        <div className="card">
                            <div className="card-body">
                                ...
                                <div>
                                    ...
                                    NukeViet”, “ban điều hành NukeViet”, "Ban
                                    Quản Trị NukeViet" và nói chung là những gì
                                    liên quan đến NukeViet...) không liên quan
                                    gì đến việc chúng tôi điều hành website cũng
                                    như quy định bạn được phép làm và không được
                                    phép làm gì trên website này.
                        ...
                        <div className="card">
                            <div className="card-body">
                                ...
                                <div>
                                    ...
                                    kết đến hoặc từ website này ("Các website
                                    khác") được điều hành và duy trì hoàn toàn
                                    độc lập bởi các bên thứ ba đó và không nằm
                                    trong quyền điều khiển và/hoặc giám sát của
                                    chúng tôi. Việc truy cập các website khác
                                    phải được tuân thủ theo các điều khoản và
                                    điều kiện quy định bởi ban điều hành của
                                    website đó.
