...
import { DATATONGHOP } from "../../action/action";
import API from "../../API/API";
import { connect } from "react-redux";

function DashBoar({ data, dataTongHop }) {
    console.log(data);
...
const mapStateToProps = (state) => ({
    data: state.data,
    dataTongHop: state.dataTongHop,
});
const mapDispatchToProps = {
    DATATONGHOP,
};

export default connect(mapStateToProps, mapDispatchToProps)(DashBoar);
